...
<html>
	...
	<title>Web Software Manager</title>
        ...
        <style type="text/css">
            ...
            #Installer { margin-left: 333px; margin-top: 25px; }
    ...
    <body>
        <div id="body">
            <div id="Header">
                ...
                <h2>Web Software Manager</h2>
                <h4>f&uuml;r kVASy&reg; System Control<font color="#82abcc"> - Version 2 Update 3</font></h4>
                <p>Dieser Web Software Manager installiert und konfiguriert, deinstalliert und updated Basis Einstellungen f&uuml;r das<br>
